...
<div class="structure-box">
    <div
        class="structure-box__part structure-box__part_margin"
        class:structure-box__part_highlight={$highlightPart & 1}
        on:mouseenter={onMouseEnter}
        on:mouseleave={onMouseLeave}
        role="region"
    >
        <div class="structure-box__title">margin</div>
        <div class="structure-box__val structure-box__val_top">
            {margin.top}
        </div>
        <div class="structure-box__val structure-box__val_bottom">
            {margin.bottom}
        </div>
        <div class="structure-box__val structure-box__val_left">
            {margin.left}
        </div>

        <div
            class="structure-box__part structure-box__part_padding"
            class:structure-box__part_highlight={$highlightPart & 2}
            on:mouseenter={onPaddingMouseEnter}
            on:mouseleave={onPaddingMouseLeave}
            role="region"
        >
            ...
            <div
                class="structure-box__part structure-box__part_content"
                class:structure-box__part_highlight={$highlightPart & 4}
            ...
            <div class="structure-box__val structure-box__val_right">
                {padding.right}
            </div>
        </div>
